...
/* harmony import */ var _modules_modal__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_modules_modal__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _modules_accordions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/accordions */ "./js/modules/accordions.js");
/* harmony import */ var _modules_accordions__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_modules_accordions__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _modules_mask__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/mask */ "./js/modules/mask.js");
/* harmony import */ var _modules_mask__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_modules_mask__WEBPACK_IMPORTED_MODULE_4__);
...
var accordionTitles = document.querySelectorAll('.footer h2');
var accordionLists = document.querySelectorAll('.footer__list');
accordionLists.forEach(function (list) {
  list.classList.remove('footer__list--opened');
});
accordions.forEach(function (accordion) {
  var tab = accordion.querySelector('.footer h2');
...
var modalOpenButton = document.querySelector('.nav__button');
var modalCloseButton = document.querySelector('.modal__button');
var modal = document.querySelector('.modal');
var nameField = document.querySelector('.modal [type="text"]'); // focus trap for modal

var focusableEls = modal.querySelectorAll('button:not([disabled]), textarea:not([disabled]), input[type="text"]:not([disabled]), input[type="checkbox"]:not([disabled]), input[type="tel"]:not([disabled])');
